...
function rowToTask(r) {
  return {
    ...
    gosb:         r.gosb,
    vsp:          r.vsp,
    dateZayavki:  r.date_zayavki   ? new Date(r.date_zayavki).toISOString('en-CA') : null,
    deadline:     r.deadline       ? new Date(r.deadline).toISOString('en-CA') : null,
    currentDate:  r.date_vnesen   ? new Date(r.date_vnesen).toISOString('en-CA') : null,
    manager:      r.manager,
    contact:      r.contact,
    ...
    dostup:       r.dostup,
    dataVyhoda:   r.data_vyhoda  ? new Date(r.data_vyhoda).toISOString('en-CA') : null,
    priemka:      r.priemka,
    oplata:       r.oplata,
